...
class ShoppingSell extends StatefulWidget {
  ShoppingSell({Key key, this.title}) : super(key: key);
  final String title;

  @override
  _ShoppingSellState createState() => new _ShoppingSellState();
}

class _ShoppingSellState extends State<ShoppingSell>
  ...
  var alertDialog = AlertDialog(
      ...
      content: Column(mainAxisSize: MainAxisSize.min, children: <Widget>[
        ...
        RaisedButton(
          ...
          color: Colors.redAccent,
          onPressed: () {
            Navigator.popUntil(context, ModalRoute.withName('/Buy Sell'));
          },
        )
      ]));
