...
class EditVehicle extends StatefulWidget {
  EditVehicle({Key key, this.title}) : super(key: key);
  final String title;

  @override
  _EditVehicleState createState() => new _EditVehicleState();
}
  ...
  var alertDialog = AlertDialog(
      ...
      content: Column(mainAxisSize: MainAxisSize.min, children: <Widget>[
        ...
        RaisedButton(
          ...
          color: Colors.redAccent,
          onPressed: () {
            Navigator.popUntil(context, ModalRoute.withName('/Product Details'));
          },
        )
      ]));
